...
- 🤖 **Accessibility:** Simple and intuitive interface focused on user experience (UX).

### 💻 Tech Stack
- **Language:** Python
- **AI & Computer Vision:** OpenCV, MediaPipe, TensorFlow / PyTorch
...
- 💬 **Tradução em Tempo Real:** Conversão de gestos em Libras para texto/áudio em tempo real.
- 🤖 **Acessibilidade:** Interface simples e intuitiva focada em experiência do usuário (UX).

### 💻 Tecnologias Utilizadas
- **Linguagem:** Python
- **IA e Visão Computacional:** OpenCV, MediaPipe, TensorFlow / PyTorch
- **Frontend / Interface:** Streamlit / React
- **Backend:** FastAPI
...
2. Create a new branch (`git checkout -b feature/my-feature`) / Crie uma nova branch
3. Commit your changes (`git commit -m 'Add new feature'`) / Salve suas alterações
4. Push to the branch (`git push origin feature/my-feature`) / Envie suas alterações
